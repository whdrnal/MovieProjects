    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('open_day', models.CharField(max_length=50, verbose_name='영화개봉날짜')),
                ('director_name', models.CharField(max_length=100, verbose_name='감독이름')),
                ('genre', models.CharField(max_length=100, verbose_name='장르')),
                ('english_movie_name', models.CharField(max_length=100, verbose_name='영어영화이름')),
            ],
        ),
        migrations.CreateModel(
            name='MovieCategory',
